...
class RealEstateTasks:
    ...
    def analyze_market_trends(self, agent, input_data):
        return Task(
            ...
            Conduct three specific analyses:
            ...
            Your final answer should include all three analyses in a structured JSON format
            that can be used by the investment advisor agent.
            """,
            agent=agent,
            expected_output="Comprehensive market analysis with price trends, ROI assessment, and growth drivers in JSON format"
        )
